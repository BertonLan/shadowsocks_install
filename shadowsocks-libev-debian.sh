...
get_latest_version(){
    ...
    init_script_link="https://raw.githubusercontent.com/BertonLan/shadowsocks_install/master/shadowsocks-libev-debian"
}
...
pre_install(){
    ...
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="berton.github.io"
    echo
    echo "---------------------------"
...
install_shadowsocks(){
    ...
    if [ $? -eq 0 ]; then
        ...
        echo
        echo -e "[${red}Error${plain}] Shadowsocks-libev install failed. please visit https://github.com/BertonLan and contact."
        exit 1
    fi
